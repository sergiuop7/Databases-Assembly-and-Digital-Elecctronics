#line 1 "F:/ANUL II/SEM I/Electronica digitala/Laboratoare/Laborator 5/Laborator_5.c"

char digit = 0;
int adcxl,adcxh,r,ms,s;
...
void Timer0() iv IVT_ADDR_TIMER0_COMP ics ICS_AUTO {
 digit++;
 switch(digit){
 case 1: display(1,r % 10); break;
 case 2: display(2,(r/10)%10); break;
 case 3: display(3,(r/100)%10); break;
 case 4: display(4,(r/1000)%10);digit = 0; break;
 }
 if(ms == 999){
 r = read_ADC(6);
 ms = 0;
